...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // About Content Admin
    'admin.about.title': 'About Us Content',
    'admin.about.sections': 'Sections',
    'admin.about.hero': 'Hero Section',
    'admin.about.story': 'Story Section',
    'admin.about.team': 'Team Section',
    'admin.about.values': 'Values Section',
    'admin.about.experience': 'Experience Section',
    'admin.about.save': 'Save Content',
    'admin.about.saved': 'Content Saved',
    'admin.about.error': 'Error Saving Content',
    'admin.about.heroTitle': 'Hero Title',
    'admin.about.heroSubtitle': 'Hero Subtitle',
    'admin.about.storyTitle': 'Story Title',
    'admin.about.storyContent': 'Story Content',
    'admin.about.teamTitle': 'Team Title',
    'admin.about.teamMembers': 'Team Members',
    'admin.about.valuesTitle': 'Values Title',
    'admin.about.valuesList': 'Values List',
    'admin.about.experienceTitle': 'Experience Title',
    'admin.about.experienceContent': 'Experience Content',
    'admin.about.addMember': 'Add Team Member',
    'admin.about.memberName': 'Name',
    'admin.about.memberRole': 'Role',
    'admin.about.memberBio': 'Bio',
    'admin.about.removeMember': 'Remove',
    'admin.about.addValue': 'Add Value',
    'admin.about.valueTitle': 'Title',
    'admin.about.valueDescription': 'Description',
    'admin.about.valueColor': 'Color',
    'admin.about.removeValue': 'Remove',
  ...
  am: {
    ...
    // Admin
    'admin.title': 'Ադմինիստրատորի վահանակ',
    'admin.dashboard': 'Վահանակ',
    'admin.products': 'Ապրանքներ',
    'admin.meatTypes': 'Մսի տեսակներ',
    'admin.backToSite': 'Վերադառնալ կայք',
    'admin.logoutSuccess': 'Դուք դուրս եկաք',
    'admin.loggedOutMessage': 'Դուք դուրս եկաք ադմինիստրատորի վահանակից',
    'admin.login.title': 'Ադմինիստրատորի մուտք',
    ...
    'admin.productDeleted': 'Ապրանքը հաջողությամբ ջնջվեց',
    ...
    'admin.meatType.createSuccess': 'Մսի տեսակը ստեղծվեց',
    'admin.meatType.createSuccessDescription': 'Մսի տեսակը հաջողությամբ ստեղծվեց',
    'admin.meatType.updateSuccess': 'Մսի տեսակը թարմացվեց',
    'admin.meatType.updateSuccessDescription': 'Մսի տեսակը հաջողությամբ թարմացվեց',
    'admin.meatType.deleteSuccess': 'Մսի տեսակը ջնջվեց',
    'admin.meatType.deleteSuccessDescription': 'Մսի տեսակը հաջողությամբ ջնջվեց',
    'admin.meatType.error': 'Մսի տեսակի սխալ',
    'admin.meatType.confirmDelete': 'Հաստատեք ջնջումը',
    ...
    // About Content Admin
    'admin.about.title': 'Մեր մասին բովանդակություն',
    'admin.about.sections': 'Բաժիններ',
    'admin.about.hero': 'Հերոսական բաժին',
    'admin.about.story': 'Պատմության բաժին',
    'admin.about.team': 'Թիմի բաժին',
    'admin.about.values': 'Արժեքների բաժին',
    'admin.about.experience': 'Փորձառության բաժին',
    'admin.about.save': 'Պահպանել բովանդակությունը',
    'admin.about.saved': 'Բովանդակությունը պահպանվեց',
    'admin.about.error': 'Բովանդակության պահպանման սխալ',
    'admin.about.heroTitle': 'Հերոսական վերնագիր',
    'admin.about.heroSubtitle': 'Հերոսական ենթավերնագիր',
    'admin.about.storyTitle': 'Պատմության վերնագիր',
    'admin.about.storyContent': 'Պատմության բովանդակություն',
    'admin.about.teamTitle': 'Թիմի վերնագիր',
    'admin.about.teamMembers': 'Թիմի անդամներ',
    'admin.about.valuesTitle': 'Արժեքների վերնագիր',
    'admin.about.valuesList': 'Արժեքների ցանկ',
    'admin.about.experienceTitle': 'Փորձառության վերնագիր',
    'admin.about.experienceContent': 'Փորձառության բովանդակություն',
    'admin.about.addMember': 'Ավելացնել թիմի անդամ',
    'admin.about.memberName': 'Անուն',
    'admin.about.memberRole': 'Դեր',
    'admin.about.memberBio': 'Կենսագրություն',
    'admin.about.removeMember': 'Հեռացնել',
    'admin.about.addValue': 'Ավելացնել արժեք',
    'admin.about.valueTitle': 'Վերնագիր',
    'admin.about.valueDescription': 'Նկարագրություն',
    'admin.about.valueColor': 'Գույն',
    'admin.about.removeValue': 'Հեռացնել',
  ...
  ru: {
    ...
    // About Content Admin
    'admin.about.title': 'Содержание о нас',
    'admin.about.sections': 'Разделы',
    'admin.about.hero': 'Главный раздел',
    'admin.about.story': 'Раздел истории',
    'admin.about.team': 'Раздел команды',
    'admin.about.values': 'Раздел ценностей',
    'admin.about.experience': 'Раздел опыта',
    'admin.about.save': 'Сохранить содержание',
    'admin.about.saved': 'Содержание сохранено',
    'admin.about.error': 'Ошибка сохранения содержания',
    'admin.about.heroTitle': 'Заголовок главного раздела',
    'admin.about.heroSubtitle': 'Подзаголовок главного раздела',
    'admin.about.storyTitle': 'Заголовок истории',
    'admin.about.storyContent': 'Содержание истории',
    'admin.about.teamTitle': 'Заголовок команды',
    'admin.about.teamMembers': 'Члены команды',
    'admin.about.valuesTitle': 'Заголовок ценностей',
    'admin.about.valuesList': 'Список ценностей',
    'admin.about.experienceTitle': 'Заголовок опыта',
    'admin.about.experienceContent': 'Содержание опыта',
    'admin.about.addMember': 'Добавить члена команды',
    'admin.about.memberName': 'Имя',
    'admin.about.memberRole': 'Роль',
    'admin.about.memberBio': 'Биография',
    'admin.about.removeMember': 'Удалить',
    'admin.about.addValue': 'Добавить ценность',
    'admin.about.valueTitle': 'Заголовок',
    'admin.about.valueDescription': 'Описание',
    'admin.about.valueColor': 'Цвет',
    'admin.about.removeValue': 'Удалить',
